...
int main(void)
{
    ...
    GLCall(glBindBuffer(GL_ARRAY_BUFFER, buffer));//Permet de specifier de que l'on veut voir affiché
    ...
    GLCall(glBindBuffer(GL_ELEMENT_ARRAY_BUFFER, ibo));//Permet de specifier de que l'on veut voir affiché
